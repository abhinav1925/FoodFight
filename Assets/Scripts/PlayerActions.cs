...
public class PlayerActions : MonoBehaviour
{
    ...
    public float donutshotpower = 5.5f;
    public float bananashotpower = 5.0f;
    public float burgershotpower = 4.5f;
    ...
    void Update()
    {
        if ((Input.GetKeyDown(KeyCode.Escape) || Input.GetKeyDown(KeyCode.P)) && GameController.paused)
        {
        ...
        else if ((Input.GetKeyDown(KeyCode.Escape) || Input.GetKeyDown(KeyCode.P)) && !GameController.paused)
        {
